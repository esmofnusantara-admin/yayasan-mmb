...
export default function SmallGroupsTab({
  ...
  const [internalSubView, setInternalSubView] = useState<'groups' | 'matrix' | 'meetings' | 'materials'>('groups');
  const activeSubView = controlledSubView !== undefined ? (controlledSubView === 'relations' ? 'groups' : controlledSubView) : internalSubView;
  const setActiveSubView = (val: 'groups' | 'matrix' | 'meetings' | 'materials') => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-100 border border-slate-200 p-1 rounded-lg flex max-w-2xl shadow-xs my-2 overflow-x-auto">
        <button
